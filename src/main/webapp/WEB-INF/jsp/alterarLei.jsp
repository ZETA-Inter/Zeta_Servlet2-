...
<%
    Lei lei = (Lei) request.getAttribute("lei");
    int idAula  = lei.getIdAula();
    String texto = lei.getLei();
    int id = lei.getId();

%>
<form action="alterarLeiCompleto" method="get" id="adicionar" autocomplete="off">
    <h1>Lei</h1>
