...
<%@ page import="com.zeta_servlet.model.Lei" %>
...
<div id="consultar">
    <h1>Lei - Aula: <%= request.getAttribute("nomeAula")%></h1>
    ...
    <div id="tabela">
        <table style="padding: 0; margin: 0;">
            ...
            <%
                ...
                List<Lei> lisA = (List<Lei>) request.getAttribute("list");
                int idAula = lisA.get(0).getIdAula();
                for (int i = 0; i < lisA.size(); i++) {
                    String lei = lisA.get(i).getLei();
    ...
    <a href="adicionarLei?idAula=<%=idAula%>">
