...
<div id="consultar">
    <h1>Texto Corrido - Aula: <%= request.getAttribute("nomeAula")%></h1>
    <div id="query">
        <div id="buscas">
    ...
    <div id="tabela">
        <table style="padding: 0; margin: 0;">
            ...
            <tr style="border-radius: 12px">
                ...
                <td class="name-title" style="text-align: center">TextoCorrido</td>
            ...
            <%
                List<TextoCorrido> lisA = (List<TextoCorrido>) request.getAttribute("list");
                int idAula = lisA.get(0).getIdAula();
                for (int i = 0; i < lisA.size(); i++) {
                    String texto = lisA.get(i).getTextoCorrido();
            ...
            <tr style="padding: 0; border-radius: 12px">
                ...
                <td><%= texto%></td>
                <td><%= idAula%></td>
                <td><form action="alterarTexto" id="alterar" method="get">
                    <input type="hidden" value="<%= id%>" name="i">
                    <button type="submit"><img src="assets/alterar.svg"></button>
                </form>

                    <form action="deletarTexto" method="get" id="deletar">
    ...
    <a href="adicionarTexto?idAula=<%=idAula%>">
