...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/adicionarFlash.css">
...
%>
<form action="adicionarFlashCompleto" method="get" id="adicionar" autocomplete="off">
    <h1>Flash Card</h1>
